...
def compress_string(value):
    return base64.b64encode(gzip.compress(value.encode()))
...
class MonitoringTests(unittest.TestCase):
    ...
    def test_get_request_ids(self):
        ...
        result = uut.get_request_ids(events, None)
    ...
    def test_analyze_run_events(self):
        result = uut.analyze_run_events("f65dbf9d-f186-11e7-a442-2f62625222a6",
                                        test_lambda_events, None)
    ...
    def test_create_topic_message(self):
        ...
        (subject,message) = uut.create_topic_message(info, context)
